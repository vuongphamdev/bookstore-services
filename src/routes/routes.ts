...
const models: TsoaRoute.Models = {
  ...
  'Pick_TUser.Exclude_keyofTUser.password__': {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        role: { ref: 'ERole', required: true },
        status: { ref: 'EUserStatus', required: true },
      ...
      subSchemas: [
        { ref: 'TBaseModel' },
        {
          ...
          nestedProperties: {
            ...
            status: { ref: 'EShopStatus', required: true },
    ...
    type: {
      ...
      subSchemas: [
        { ref: 'TBaseModel' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            metadata: { dataType: 'union', subSchemas: [{ dataType: 'string' }, { dataType: 'enum', enums: [null] }] },
            status: { ref: 'EProductStatus', required: true },
  ...
  TTopSellingProduct: {
    ...
    type: {
      ...
      subSchemas: [
        { ref: 'TProduct' },
        { dataType: 'nestedObjectLiteral', nestedProperties: { total_sales: { dataType: 'double', required: true } } },
      ],
      validators: {},
    },
  },
    ...
    properties: {
      ...
      data: {
        ...
        nestedProperties: {
          ...
          items: { dataType: 'array', array: { dataType: 'refAlias', ref: 'TProduct' }, required: true },
        },
      },
      error: { ref: 'Record_string.string_' },
    },
      ...
      subSchemas: [
        { ref: 'TBaseModel' },
        {
          ...
          nestedProperties: {
            ...
            status: { ref: 'EOrderStatus', required: true },
            user_id: { dataType: 'double', required: true },
            shop_id: { dataType: 'double', required: true },
          },
        },
    ...
    type: {
      ...
      subSchemas: [
        { ref: 'TOrderItem' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            product_sku: { dataType: 'string', required: true },
      ...
      subSchemas: [
        { ref: 'TOrder' },
        {
          ...
          nestedProperties: {
            ...
            order_items: {
              dataType: 'array',
              array: { dataType: 'refAlias', ref: 'TOrderItemWithProduct' },
              required: true,
            },
          },
        },
  ...
  TCreateOrderRequestBody: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        shop_id: { dataType: 'union', subSchemas: [{ dataType: 'double' }, { dataType: 'enum', enums: [null] }] },
  ...
  'ApiResponse__accessToken-string__': {
    ...
    properties: {
      ...
      data: {
        dataType: 'nestedObjectLiteral',
        nestedProperties: { accessToken: { dataType: 'string', required: true } },
      },
      error: { ref: 'Record_string.string_' },
    },
    additionalProperties: false,
    ...
    properties: {
      ...
      data: {
        ...
        nestedProperties: {
          ...
          user: { ref: 'TUserResponse', required: true },
        },
      },
      error: { ref: 'Record_string.string_' },
    },
...
export function RegisterRoutes(app: Router) {
    ...
    async function ReportController_getTopSellingProducts(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReportController_getTopSellingProducts,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function ProductController_searchProducts(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductController_searchProducts,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function ProductController_createProduct(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductController_createProduct,
          request,
          response,
        });
  ...
  app.put(
    ...
    async function ProductController_updateProduct(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductController_updateProduct,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function ProductController_deleteProduct(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductController_deleteProduct,
          request,
          response,
        });
  ...
  app.patch(
    ...
    async function ProductController_updateProductStock(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductController_updateProductStock,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function OrderController_getOrderItems(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrderController_getOrderItems,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function OrderController_removeOrderItem(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrderController_removeOrderItem,
          request,
          response,
        });
